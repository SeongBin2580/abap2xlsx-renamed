...
* Create node filtercolumn
  ...
  METHOD add_conditional_formatting.
    DATA: lo_element               TYPE REF TO if_ixml_element,
          ...
          lv_value                 TYPE string,
          ls_databar               TYPE zppt_xls_condition_databar,      " Databar by Albert Lladanosa
          ls_colorscale            TYPE zppt_xls_condition_colorscale,
          ls_iconset               TYPE zppt_xls_condition_iconset,
          ls_cellis                TYPE zppt_xls_condition_cellis,
          ...
          ls_expression            TYPE zppt_xls_condition_expression,
          ls_conditional_top10     TYPE zppt_xls_condition_top10,
          ls_conditional_above_avg TYPE zppt_xls_condition_above_avg,
